      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="form-control">
            ...
            <label className="input outline-none flex items-center gap-3 focus-within:border-success w-full focus-within:ring-2 focus-within:ring-success/20 transition-all">
              ...
              <input
                ...
                className="grow w-full text-sm bg-transparent outline-none placeholder:text-base-content/30"
                required
              />
            </label>
          </div>
          ...
          <div className="form-control">
            ...
            <label className="input w-full outline-none flex items-center gap-3 focus-within:border-success focus-within:ring-2 focus-within:ring-success/20  transition-all">
              <User size={16} className="text-base-content/40 shrink-0" />
              <input
                type="text"
                name="fatherName"
                ...
                className="grow text-sm w-full bg-transparent outline-none placeholder:text-base-content/30"
                required
              />
            </label>
          </div>
